...
> **Status:** **v3.5.0 on `main`** — stable offline baseline ✅ · **v3.4.0** legal refresh ✅ · Tier 4a.0 **✅ functional** · **UX-4a ✅** (v3.3.3) · **4a-pre ✅** mobile notices (v3.3.3) · **4a-pre-b ✅** mobile offline dock + Settings+toast (v3.3.4) · **4a.1** metrics UX pending · **4b** editing planned  
