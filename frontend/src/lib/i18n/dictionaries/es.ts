...
const es: Dictionary = {
  ...
  settings: {
    ...
    offline: {
      ...
      cacheOverviewLabel: "Resumen de cache",
      cacheOverviewHint: "Shell {shell} rutas · Motores {engines} · {size} almacenados.",
      enginesShort: "motores",
      shellShort: "shell",
      storageShort: "almacenado",
      syncLabel: "Sincronizar motores",
      syncHint: "Verifica si los motores Wasm en cache coinciden con el build mas reciente.",
      syncHintWithVersion: "Motor v{version} · build {buildId}. Verifica si los motores coinciden con este build.",
      syncProgressHint: "Actualizando motores… {done}/{total}",
      syncIdle: "Sin verificar",
      syncChecking: "Verificando…",
      syncUpToDate: "Actualizado",
      syncStale: "Actualizacion disponible",
      syncing: "Actualizando…",
      syncError: "No se pudo verificar",
      syncUpdateAction: "Actualizar motores",
      syncCheckAction: "Verificar ahora",
      syncCheckingAction: "Verificando…",
      syncAutoLabel: "Detectar actualizaciones de motores",
      syncAutoHint: "Verificar automaticamente cambios en motores Wasm al abrir Ajustes.",
      syncDone: "Motores Wasm actualizados al build mas reciente.",
      syncFailed: "No se pudieron actualizar los motores. Permanece en linea e intentalo de nuevo.",
      syncStaleToast: "Hay un build mas reciente de motores Wasm. Pulsa Actualizar motores.",
      syncUpToDateToast: "Los motores Wasm estan actualizados.",
      ...
      offlineModeHint:
        "Trabaja solo desde cache en esta pestaña. Requiere app shell y motores Wasm cacheados.",
      ...
      maintenanceHint: "Restaura el app shell para recarga offline o borra todos los datos en cache.",
