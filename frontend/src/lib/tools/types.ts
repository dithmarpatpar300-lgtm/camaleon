...
export type ImageFormat =
  ...
  | "AVIF"
  | "SVG";
export type ToolCategory = "image" | "optimize";
...
export type SliderOptionSpec = {
  kind: "slider";
  key: "quality" | "compression" | "iconSize" | "speed" | "outputScale" | "resizePercent" | "subsampling" | "optimizationLevel" | "lossyMode" | "lossyColors";
  min: number;
  max: number;
  step: number;
  defaultValue: number;
