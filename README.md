...
**v3.7.1** (App) · Engine v1.7.0 · **Live:** [camaleon.bckthead3001.workers.dev](https://camaleon.bckthead3001.workers.dev) · [GitHub](https://github.com/dithmarpatpar300-lgtm/camaleon) · [ARCHITECTURE](ARCHITECTURE.md) · [SPEC](docs/SPEC.md) · [ROADMAP](docs/ROADMAP.md)
...
**Latest (v3.7.1):** **Compress Premium Phase B — JPEG encoder swap** — replaced `image::JpegEncoder` with `jpeg-encoder` crate: optimized Huffman tables, chroma subsampling control (4:2:0/4:2:2/4:4:4). 5-15% smaller JPEG files at same quality. Subsampling slider on `jpg-compress`. See [docs/releases/v3.7.1.md](docs/releases/v3.7.1.md). **Prior (v3.7.0):** **Compress Premium Phase A** — honesty notices, color type fix, defaults. See [docs/releases/v3.7.0.md](docs/releases/v3.7.0.md). **Next:** Phase C — PNG lossless optimization (oxipng spike). [ROADMAP](docs/ROADMAP.md) · [Tier 4 plan](docs/planning/tier4_plan.md).
