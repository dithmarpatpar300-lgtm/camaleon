...
declare module "*/transmutador_optimize/transmutador_optimize.js" {
  ...
  export function recompress_webp(input_bytes: Uint8Array): Uint8Array;
  export function recompress_webp_with_options(input_bytes: Uint8Array, use_predictor: boolean, opt_level: number): Uint8Array;
  export function estimate_webp_recompress_size(input_bytes: Uint8Array): number;
  export function estimate_webp_recompress_with_options(input_bytes: Uint8Array, use_predictor: boolean, opt_level: number): number;
  export function set_session_input_limit(max_bytes: number): void;
  export function reset_session_input_limit(): void;
  export function set_risk_mode(enabled: boolean): void;
  export default function init(): Promise<void>;
