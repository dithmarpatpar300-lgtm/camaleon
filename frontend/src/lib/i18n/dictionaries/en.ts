...
const en: Dictionary = {
  ...
  settings: {
    ...
    offline: {
      ...
      cacheOverviewLabel: "Cache overview",
      cacheOverviewHint: "Shell {shell} routes · Engines {engines} · {size} stored.",
      enginesShort: "engines",
      shellShort: "shell",
      storageShort: "stored",
      syncLabel: "Engine sync",
      syncHint: "Checks if cached Wasm engines match the latest deployed build.",
      syncHintWithVersion: "Engine v{version} · build {buildId}. Checks if cached engines match this build.",
      syncProgressHint: "Updating engines… {done}/{total}",
      syncIdle: "Not checked",
      syncChecking: "Checking…",
      syncUpToDate: "Up to date",
      syncStale: "Update available",
      syncing: "Updating…",
      syncError: "Unable to check",
      syncUpdateAction: "Update engines",
      syncCheckAction: "Check now",
      syncCheckingAction: "Checking…",
      syncAutoLabel: "Auto-detect engine updates",
      syncAutoHint: "Automatically check for Wasm engine changes when Settings opens.",
      syncDone: "Wasm engines updated to the latest build.",
      syncFailed: "Could not update engines. Stay online and try again.",
      syncStaleToast: "A newer Wasm build is available. Tap Update engines to sync.",
      syncUpToDateToast: "Wasm engines are up to date.",
      ...
      offlineModeHint:
        "Work from cache only in this tab. Requires cached app shell and Wasm engines.",
      ...
      maintenanceHint: "Restore the app shell for offline reload, or clear all cached data.",
