...
// ---------------------------------------------------------------------------
// image-webp KEYFRAME_YMODE_PROBS — fixed 4-value array (no context)
...
// ---------------------------------------------------------------------------
// image-webp KEYFRAME_UV_MODE_PROBS — fixed 3-value array
...
// ---------------------------------------------------------------------------
// COEFF_UPDATE_PROBS — probabilities for token probability updates
// Structure: [4 types][8 bands][3 contexts][11 nodes]
// Source: image-webp 0.2.4 COEFF_UPDATE_PROBS
// ---------------------------------------------------------------------------

static COEFF_UPDATE_PROBS: [[[[u8; 11]; 3]; 8]; 4] = [
    [
...
/// Get a coefficient update probability value.
pub fn get_coeff_update_prob(ctype: usize, band: usize, ctx: usize, node: usize) -> u8 {
    COEFF_UPDATE_PROBS[ctype][band][ctx][node]
}
